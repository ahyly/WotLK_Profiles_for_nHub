...
local items = {
	...
	{ type = "title", text = "Beastmaster Hunter by DarhangeR" },
	{ type = "separator" },
...
ni.bootstrap.rotation("BeastMaster_DarhangeR", queue, abilities, data, { [1] = "Beastmaster Hunter by DarhangeR", [2] = items });