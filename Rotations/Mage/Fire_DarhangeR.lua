...
local items = {
	...
	{ type = "separator" },
	{ type = "entry", text = "Dragon's Breath", tooltip = "Use spell when enemie in range for that. If Dragon's Breath not learned it use Cone of Cold", enabled = false, key = "breath" },
