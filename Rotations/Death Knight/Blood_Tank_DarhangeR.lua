...
local items = {
	...
	{ type = "separator" },
	{ type = "entry", text = "Death Strike (Lich)", tooltip = "Use spell when player HP < %", enabled = true, value = 75, key = "deathstrike" },
	...
	{ type = "separator" },
	{ type = "entry", text = "Rune Tap", tooltip = "Use spell when player HP < %", enabled = true, value = 55, key = "runetap" },
	{ type = "entry", text = "Vampiric Blood", tooltip = "Use spell when player HP < %", enabled = true, value = 75, key = "vampblood" },
	{ type = "entry", text = "Mark of Blood", tooltip = "Use spell when player HP < %", enabled = true, value = 25, key = "markofblood" },
	{ type = "entry", text = "Icebound Fortitude", tooltip = "Use spell when player HP < %", enabled = true, value = 40, key = "iceboundfort" },
	...
	{ type = "separator" },
	{ type = "entry", text = "Dark Command (Auto Agro)", tooltip = "Auto use spell to agro enemies in 30 yard radius", enabled = false, key = "dark" },
	{ type = "entry", text = "Death Grip (Auto Agro)", tooltip = "Auto use spell to agro enemies in 30 yard radius", enabled = false, key = "grip" },		
	{ type = "separator" },
